...
<body>
<cfif session.user.username NEQ ""> 
		 ...
		 <ul class="nav navbar-nav  pull-right">
            ...
            <li class="dropdown">
             <a href="##" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">#SESSION.user.username# <span class="caret"></span></a>
			  ...
			  <li>Current users</li>
               <cfloop list="#Application.username#" index="UserName" delimiters="#chr(9)#">
...
<div class="container">
  <div class="row content">
	...
	<input type="submit" name="LogMeIn" class="btn btn-success" value="Log In">
